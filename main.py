...
# credits ==>
print("Welcome to Facial Recognition Attendance System v3.4 created by Hrithik Singh.")
print("Loading...")
...
hrithik_image = face_recognition.load_image_file("faces/hrithik.jpg")
hrithik_encoding = face_recognition.face_encodings(hrithik_image)[0]

soumen_image = face_recognition.load_image_file("faces/soumen.jpg")
soumen_encoding = face_recognition.face_encodings(soumen_image)[0]

known_face_encodings = [hrithik_encoding, soumen_encoding]
known_face_names = ["hrithik", "soumen"]
